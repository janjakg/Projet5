...
<div class="row">
  <div class="table-responsive">
    <table class="table table-hover table-bordered table-dark">
      ...
      <tbody>
        <!--On va faire une boucle qui va nous permettre de récupérer dans la base de données les données les titres et autres infos, et mise en place d'un CRUD-->
        <?php while ($list = $nombredElementsTotal->fetch()): ?>
        <tr>
          <td><strong><?=(stripslashes(strip_tags($list['title'])))?></strong>
          </td>
          <td>
            <?=stripslashes(strip_tags((substr($list['artist'], 0, 90))))?>
          </td>
    ...
    <a href="#" id="scrollButton" style="display: none;"><i class="fas fa-arrow-alt-circle-up"></i></a>
